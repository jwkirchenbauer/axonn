...
def dummy_clip_grad_norm_measure_only_(
    parameters, max_norm, norm_type=2.0, error_if_nonfinite=False
):
    print("Hitting local 'clip' fn where we just measure the norm")
...
def clip_grad_norm_(parameters, max_norm, norm_type=2.0, error_if_nonfinite=False):
    ...
    # resulting_norm = dummy_clip_grad_norm_measure_only_(
    #     parameters, max_norm, norm_type, error_if_nonfinite
    # )
    # print("Total norm (after clipping): ", resulting_norm)
